...
X, y = make_classification(
    ...
    n_informative=15,
    n_redundant=5,
    n_classes=5,  # 5 distinct target classes
    random_state=42
)
...
# ---------------------------------------------------------------------
# 2. Build Multilayer Perceptron (MLP) Architecture
# ---------------------------------------------------------------------
...
# 3. Compile Model
# ---------------------------------------------------------------------
# Sparse Categorical Crossentropy avoids needing manually one-hot encoded vectors.
model.compile(
...
# Map probabilities to predicted discrete class indices
